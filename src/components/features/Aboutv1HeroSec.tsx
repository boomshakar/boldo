...
const Aboutv1HeroSec = () => {
  return (
    <section className="hero_illustration_contain container">
      <div className="illustration_list">
        <div className="illustration_list_item">
          <img src="/assets/images/customer_conn1.png" alt="" />
        </div>
